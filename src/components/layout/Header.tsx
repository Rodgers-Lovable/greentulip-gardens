      ...
      <nav className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a href="tel:+254700000000" className={cn(
              'flex items-center gap-2 text-sm font-medium transition-colors',
              isScrolled ? 'text-forest hover:text-gold' : 'text-cream hover:text-gold'
            )}>
          ...
          >
            {isMobileMenuOpen ? (
              <X className={cn('h-6 w-6', isScrolled ? 'text-forest' : 'text-cream')} />
            ) : (
              <Menu className={cn('h-6 w-6', isScrolled ? 'text-forest' : 'text-cream')} />
            )}
          </button>
        </div>
      </nav>
