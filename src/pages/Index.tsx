...
const experiences = [
  {
    ...
    description:
      "Create unforgettable moments in our stunning garden setting, perfect for your dream wedding.",
  ...
  },
  {
    ...
    description:
      "Escape the city and enjoy a peaceful day surrounded by lush greenery and natural beauty.",
  ...
  },
  {
    ...
    title: "Accommodation",
    description:
      "Stay overnight in our comfortable cottages and wake up to birdsong and mountain views.",
  ...
  },
  {
    ...
    description:
      "Bond with your team in an inspiring environment that fosters creativity and connection.",
  ...
  },
  {
    ...
    description:
      "Capture stunning visuals with our diverse natural backdrops and golden hour lighting.",
...
const testimonials = [
  {
    quote:
      "GreenTulip Gardens made our wedding day absolutely magical. The setting was breathtaking and the team was incredibly professional.",
    author: "Sarah & James",
    event: "Wedding Ceremony",
  },
  {
    quote:
      "Our corporate retreat was a huge success. The peaceful environment helped our team reconnect and recharge.",
    author: "Michael K.",
    event: "Team Building Event",
  },
  {
    quote:
      "The perfect backdrop for our photoshoot. The gardens are stunning and the staff went above and beyond.",
    author: "Diana M.",
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 text-center">
          ...
          >
            ...
            <p className="text-cream/90 text-lg md:text-xl max-w-2xl mx-auto mb-10">
              Nestled in the heart of Nkubu, Meru County, GreenTulip Gardens
              offers a breathtaking natural setting for weddings, events, and
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              Set against the majestic backdrop of Mount Kenya, our gardens
              offer a serene escape where nature's beauty enhances every
              celebration. Whether you're planning an intimate gathering or a
              grand celebration, our team is dedicated to making your vision a
              reality.
            </p>
          </motion.div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 text-center">
          ...
          >
            ...
            <p className="text-cream/80 text-lg mb-8">
              Let us help you plan an unforgettable experience. Get in touch
              today for a personalized quote tailored to your needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                variant="hero"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-cream/80 text-lg mb-6">
                GreenTulip Gardens is conveniently located in Nkubu, Meru
                County, with easy access from major towns. Just a scenic drive
                from Meru Town, our venue offers ample parking and is
