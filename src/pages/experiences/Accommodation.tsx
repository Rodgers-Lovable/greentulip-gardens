...
const faqs = [
  {
    ...
    answer: 'We offer cozy cottages with various room configurations to suit couples, families, and groups. Each unit has private facilities and garden views.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Absolutely! We offer special rates for wedding parties. Contact us to discuss group bookings and packages.',
  },
];
...
export default function Accommodation() {
  ...
  return (
    <Layout>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-muted-foreground text-lg mb-8">
                ...
                your event or simply enjoy a getaway. Each accommodation is designed 
                to blend comfort with the natural beauty of our surroundings.
              </p>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <img src={heroImage} alt="Accommodation at GreenTulip Gardens" className="rounded-2xl shadow-large" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-secondary">
        <div className="container mx-auto max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl text-forest mb-4">Accommodation FAQs</h2>
          </motion.div>
      ...
      <section className="py-20 bg-forest text-cream">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-heading text-3xl md:text-4xl text-cream mb-4">Book Your Stay</h2>
      ...
      <QuoteModal isOpen={isQuoteModalOpen} onClose={() => setIsQuoteModalOpen(false)} eventType="Accommodation" />
    </Layout>
  );
}
