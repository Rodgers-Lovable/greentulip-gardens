...
import picnicImg1 from '@/assets/images/grounds.jpeg';
import picnicImg2 from '@/assets/images/grounds1.jpeg';
import picnicImg3 from '@/assets/images/grounds2.jpeg';
import picnicImg4 from '@/assets/images/tulip.jpg';
import picnicImg5 from '@/assets/images/river.jpg';
import picnicImg6 from '@/assets/images/image_3.jpg';

const galleryImages = [
  { src: picnicImg1, alt: 'Scenic picnic grounds at GreenTulip' },
  { src: picnicImg2, alt: 'Shaded seating areas in the garden' },
  { src: picnicImg3, alt: 'Beautiful natural surroundings' },
  { src: picnicImg4, alt: 'Colorful tulip gardens' },
  { src: picnicImg5, alt: 'Serene riverside setting' },
  { src: picnicImg6, alt: 'Family-friendly outdoor spaces' },
];
      ...
      <section className="section-padding bg-secondary">
        <div className="container mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
            <h2 className="font-heading text-3xl md:text-4xl text-forest mb-4">Picnic Spaces Gallery</h2>
            <p className="text-muted-foreground">Discover our beautiful outdoor areas perfect for day outs</p>
          </motion.div>
